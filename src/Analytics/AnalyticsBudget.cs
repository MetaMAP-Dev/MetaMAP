...
/// most once per machine per UTC day, so a Views figure is a count of machine-days rather than
/// how often someone reopens a definition.</item>
/// </list>
...
/// read or written the budget degrades to an in-memory ledger for the current process — still
...
public static class AnalyticsBudget
{
    ...
    /// budget still covers it. <c>false</c> means: already sent today, or budget spent — either
    /// way the caller drops the payload.</returns>
